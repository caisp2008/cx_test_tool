...
def init_tab10(tab_page):
    global text_device_info,text_adb_info
    monty = ttk.LabelFrame(tab_page, text=' ')
    monty.grid(column=0, row=0, padx=20, pady=20)

    tk.Button(monty, text='点击复制测试结果 ', font=("Arial", 11), width=20, height=1, command=creat_changchang_excel).grid(column=0, row=0,columnspan=2,
                                                                                                  sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1 , command =lambda: get_adb_kugou_stop(4,8,'第一次测试',1,2)).grid(column=6, row=1, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,14,'第一次测试',1,3)).grid(column=3, row=3,sticky='W',padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,20,'第一次测试',1,4)).grid(column=6, row=3, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,26,'第一次测试',1,5)).grid(column=3, row=4, sticky='W', padx=10)

    tk.Label(monty, text="          ", font=("Arial", 11), width=20, height=2).grid(column=4, row=5,
                                                                                                      sticky='W')
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,8,'第二次测试',2,2)).grid(column=6, row=6, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,14,'第二次测试',2,3)).grid(column=3, row=7, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,20,'第二次测试',2,4)).grid(column=6, row=7, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,26,'第二次测试',2,5)).grid(column=3, row=8, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,8,'第三次测试',3,2)).grid(column=6, row=11, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,14,'第三次测试',3,3)).grid(column=3, row=12, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,20,'第三次测试',3,4)).grid(column=6, row=12, sticky='W', padx=10)
    ...
    tk.Button(monty, text='点击结束 ', font=("Arial", 11), width=13, height=1,command =lambda: get_adb_kugou_stop(4,26,'第三次测试',3,5)).grid(column=3, row=13, sticky='W', padx=10)

    tk.Label(monty, text="          ", font=("Arial", 11), width=20, height=2).grid(column=4, row=15,
                                                                                    sticky='W')
...
def openReport():
    path_report = '..\performance_function_test\changchang\酷狗唱唱APP性能测试报告'
...
def get_adb_kugou_stop(begin_row,begin_col,sheet_name,n,y):
    ...
    time.sleep(10)
    write_changchang_excel(new_excel_path,begin_row,begin_col,sheet_name)
    insert_text(str(get_time()) + '第 ' + str(n) + ' 次测试__' + '场景 ' + str(y) + ' 测试结束了\n')


def creat_changchang_excel():
    import time
    global new_excel_path
    model_excel_path = os.path.abspath('..\performance_function_test\changchang\酷狗唱唱APP性能测试报告\酷狗唱唱__手机端app性能测试结果__模板.xlsx')

    time_report = time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))
    excel_result = shutil.copy(model_excel_path, u'..\performance_function_test\changchang\酷狗唱唱APP性能测试报告\酷狗唱唱__手机端性能测试报告__' + str(time_report) + '.xlsx')
...
def write_changchang_excel(new_excel_path,begin_row,begin_col,sheet_name):
